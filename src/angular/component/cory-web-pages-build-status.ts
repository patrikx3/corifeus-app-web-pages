...
@Component({
    ...
    <span  *ngIf="pkg.corifeus.build !== false" >
        ...
        <a target="cory-pages-status-travis" href="https://travis-com.org/patrikx3/{{ pkg.corifeus.reponame }}"><img src="https://api.travis-com.org/patrikx3/{{ pkg.corifeus.reponame }}.svg?branch=master" [matTooltip]="i18n.pages.title.travis" [matTooltipPosition]="tooltipPosition"></a>
